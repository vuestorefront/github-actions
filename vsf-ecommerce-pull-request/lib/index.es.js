    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = context.repo, repo = _a.repo, owner = _a.owner;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, lighthouseCheck({
                            urls: urls.split(','),
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, exec("" + command, [], options)];
            case 2:
                _a.sent();
...
var test = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, exec(command || 'yarn test --coverage --passWithNoTests --forceExit')];
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, lighthouse({
                        urls: getInput('lighthouse_urls'),
                        token: getInput('github_token'),
                        report: getInput('lighthouse_report'),
                        commentId: getInput('lighthouse_report_comment_id'),
                    })];
            case 1:
                lighthouseCheck = _a.sent();
                setOutput("Lighthouse Check Results (desktop, mobile)", JSON.stringify(lighthouseCheck));
                if (!!inputFormatter(getInput('test_disabled'))) return [3 /*break*/, 4];
                return [4 /*yield*/, test({
                        command: getInput('test_command'),
                    })];
            case 2:
                _a.sent();
                return [4 /*yield*/, coverage({
                        command: getInput('test_command'),
                        token: getInput('github_token'),
                        report: getInput('test_report'),
                        commentId: getInput('test_report_comment_id'),
                    })];
            case 3:
                coverageCheck = _a.sent();
                setOutput('Coverage Check Results', coverageCheck.toString());
                if (Number(coverageCheck) < Number(getInput('test_failed'))) {
            ...
            case 5:
                error_1 = _a.sent();
                return [2 /*return*/, setFailed(error_1)];
            case 6: return [2 /*return*/];
        }
    });
}); })();
